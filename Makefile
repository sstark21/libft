...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/01/09 13:32:48 by sstark            #+#    #+#              #
#    Updated: 2019/01/09 13:32:49 by sstark           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = libft.a
SRCS = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c ft_memcmp.c ft_strlen.c ft_strdup.c ft_strcpy.c \
...
ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c ft_lstnew.c ft_lstdelone.c ft_lstdel.c ft_lstadd.c ft_lstiter.c \
ft_lstmap.c ft_toupper.c ft_tolower.c ft_exponentiation.c ft_memchr.c ft_strnlen.c ft_wordnbr.c
OBJ = *.o
HEADER = .
